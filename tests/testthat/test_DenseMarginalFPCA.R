...
testthat::test_that('mismatched input dimension for sample size',{
  ...
  testthat::expect_error(DenseMarginalFPCA(X.age.year, 200, 15, 20, fpca.op1=NULL, fpca.op2=NULL, pc.j = NULL, pc.k = NULL))
})
...
testthat::test_that('mismatched input dimension for dimension1 and dimension2',{
  ...
  testthat::expect_error(DenseMarginalFPCA(X.age.year, n, 20, 20, fpca.op1=NULL, fpca.op2=NULL, pc.j = NULL, pc.k = NULL))
  testthat::expect_error(DenseMarginalFPCA(X.age.year, n, 15, 15, fpca.op1=NULL, fpca.op2=NULL, pc.j = NULL, pc.k = NULL))
})
...
testthat::test_that('check output dimension',{
  ...
  res <- DenseMarginalFPCA(X.age.year, n, 15, 20, fpca.op1=NULL, fpca.op2=NULL, pc.j = 2, pc.k = c(3,3))
  testthat::expect_equal(res$pc.j, 2)
  testthat::expect_equal(res$pc.k, c(3,3))
})
...
testthat::test_that('check output eigenvalues',{
  ...
  res<-DenseMarginalFPCA(Xmat, n, N, N, fpca.op1=NULL, fpca.op2=NULL, pc.j = 2, pc.k = c(2,2))
  testthat::expect_equal(4, res$res.phi[[1]]$lambda[1]/10000, tolerance = 1)
  testthat::expect_equal(2, res$res.phi[[1]]$lambda[2]/10000, tolerance = 0.5)
  testthat::expect_equal(2, res$res.phi[[2]]$lambda[1]/10000, tolerance = 0.5)
  testthat::expect_equal(1, res$res.phi[[2]]$lambda[2]/10000, tolerance = 0.25)
})
