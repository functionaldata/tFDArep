...
testthat::test_that('mismatched input dimension for sample size',{
  ...
  testthat::expect_error(DenseProductFPCA(X.age.year, 200, 15, 20, fpca.op1=NULL, fpca.op2=NULL, pc.j = NULL, pc.k = NULL))
})
...
testthat::test_that('mismatched input dimension for dimension1 and dimension2',{
  ...
  testthat::expect_error(DenseProductFPCA(X.age.year, n, 20, 20, fpca.op1=NULL, fpca.op2=NULL, pc.j = NULL, pc.k = NULL))
  testthat::expect_error(DenseProductFPCA(X.age.year, n, 15, 15, fpca.op1=NULL, fpca.op2=NULL, pc.j = NULL, pc.k = NULL))
})
...
testthat::test_that('check output dimension',{
  ...
  res <- DenseProductFPCA(X.age.year, n, 15, 20, fpca.op1=NULL, fpca.op2=NULL, pc.j = 2, pc.k = 3)
  testthat::expect_equal(res$pc.j, 2)
  testthat::expect_equal(res$pc.k, 3)
})
...
testthat::test_that('check output eigenvalues',{
  ...
  res <- DenseProductFPCA(Xmat, n, N, N, fpca.op1=NULL, fpca.op2=NULL, pc.j = 2, pc.k = 2)
  testthat::expect_equal(c(5,2,2,1), as.numeric(res$VarOrdered)/10, tolerance = 0.5)
})
